...
export default function LandingPage() {
  return (
    <main>
      <div className="flex flex-col gap-8 items-center justify-start w-full h-screen p-10 max-w-6xl mx-auto">
        <div className="absolute w-full h-screen top-10 left-0 -z-10">
          <Image
            ...
            width={2000}
            height={2000}
            className="w-full h-auto aspect-video object-cover rounded-lg brightness-75 "
          />
        </div>
        <div className="flex flex-col gap-4 items-center lg:py-32 text-white w-full">
          <p className="uppercase font-cinzel font-bold text-2xl tracking-widest opacity-70">
            Welcome to
          </p>
          <Image
            src="/gr_logo.png"
            ...
            width={1000}
            height={500}
            className="w-full h-fit object-contain -mb-20 drop-shadow-xl"
          />
          <p className="uppercase font-cinzelD font-bold text-5xl tracking-widest opacity-70 mb-32">
            Phase 1
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-4 items-center justify-center w-full min-h-screen px-52 py-20">
        <div className="flex flex-col gap-6">
          <p className="font-cinzel text-yellow-800 text-5xl tracking-widest opacity-70">
        ...
        <div className="flex flex-col gap-4 items-center h-full text-yellow-700">
          <Image
            ...
            width={1000}
            height={700}
            className="w-auto h-[90%] object-left object-cover aspect-[10/14] rounded-lg"
          />
        </div>
      </div>
      <div className="flex flex-col gap-4 items-center justify-start w-full min-h-screen px-52 py-20">
      ...
      <div className="grid grid-cols-2 gap-4 items-start justify-start w-full px-52 py-20">
        ...
        <div className="flex flex-row items-center justify-center py-4 ring-1 ring-yellow-700 text-yellow-700 font-sans text-sm opacity-70 italic">
          Exquisite villa with private pool and deck, perfect for luxury living.
        </div>
      </div>
      <div className="grid grid-cols-[1fr_2fr] gap-4 items-center justify-center w-full px-52 py-20">
        <Image
          src="/villa/grlv_7.webp"
          alt="Golden Retreat Lombok Villa"
          width={500}
      ...
      <div className="flex flex-col gap-4 items-center justify-start w-full px-52 py-20">
